...
![grid](../results/12_adain_style_transfer/adain_grid.jpg)

**User-controllable style strength** — blend content and stylised features with α ∈ [0, 1] at inference:

![alpha](../results/12_adain_style_transfer/alpha_tradeoff.jpg)
...
Optimisation-based style transfer ([project 11](../11_neural_style_transfer)) runs hundreds of L-BFGS steps per image; AdaIN trades a little fidelity for **single-pass, arbitrary-style** inference in milliseconds — what makes real-time style filters possible.
...
python 12_adain_style_transfer/train.py        # 35-min budget on an L4
```
