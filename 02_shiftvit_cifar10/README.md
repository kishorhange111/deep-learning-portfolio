...
![curves](../results/02_shiftvit_cifar10/training_curves.png)
...
## Run
```bash
python 02_shiftvit_cifar10/train.py                     # 40-min default budget
TIME_LIMIT_MIN=120 python 02_shiftvit_cifar10/train.py
```
