...
![properties](results/property_distributions.png)
![molecules](results/generated_molecules.png)
...
python generative-models/molecule-generation-transformer/train.py        # 30-minute budget
```
