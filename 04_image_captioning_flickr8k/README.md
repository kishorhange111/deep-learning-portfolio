...
Full table: [results/…/sample_captions.md](../results/04_image_captioning_flickr8k/sample_captions.md)

![curves](../results/04_image_captioning_flickr8k/training_curves.png)
...
## Run
```bash
python 04_image_captioning_flickr8k/train.py   # ~10 min on an L4 (incl. feature extraction)
```
